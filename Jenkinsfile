pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/allame'                                                                    //<------change this
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/miamioh-allame/225-lab3-5.git'                                          //<------change this
        KUBECONFIG = credentials('allame-test-credentials')                                                         //<------change this
    }
